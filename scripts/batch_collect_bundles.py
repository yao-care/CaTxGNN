...
import pandas as pd
from catxgnn.collectors import DrugBundleAggregator
from catxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from catxgnn.collectors.drug_bundle import PredictedIndication
    from catxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from catxgnn.collectors.drug_bundle import DrugBundle
