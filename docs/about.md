...
nav_order: 90
permalink: /about/
description: "CaTxGNN is a drug repurposing prediction platform developed by 藥提醒科技有限公司 (yao.care), built on the Harvard TxGNN model, covering Health Canada-approved medicines in Canada."
---
...
<p class="key-answer" data-question="What is CaTxGNN?">
<strong>CaTxGNN</strong> is a research-support platform for drug repurposing, built on the TxGNN
model published in <em>Nature Medicine</em> by the Zitnik Lab at Harvard University. It predicts
indication expansion for medicines approved by Health Canada in Canada. Beyond AI prediction scores,
...
CaTxGNN is the Canada site of the company's "TxGNN Drug Repurposing" product line.
...
<tr><td>Registration data</td><td><a href="https://www.canada.ca/en/health-canada.html">Health Canada</a></td><td>Drug approval data for Canada</td></tr>
</tbody>
</table>
...
- **GitHub Issues**: <https://github.com/yao-care/CaTxGNN/issues>
