...
Nepafenac currently holds **no active Health Canada Drug Identification Numbers (DINs)** in this dataset (`total_licenses = 0`; `market_status = Not marketed / Not Marketed`). No product-level licensing table can be generated until Canadian regulatory filing data becomes available.
