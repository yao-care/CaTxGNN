...
Indacaterol is not currently marketed in Canada under this evidence pack's regulatory data (0 DINs on file, market status "未上市"). No product authorizations are available to list.
