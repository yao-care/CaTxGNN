...
Prochlorperazine currently has **0 Health Canada drug identification numbers (DINs)** on file in this evidence pack — market status is **Not marketed (Not Marketed)**. No licensed product records are available to summarize dosage forms or approved indication text.
