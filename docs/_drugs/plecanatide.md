...
Plecanatide currently holds no drug identification numbers (DINs) in Canada and is not marketed (`market_status`: 未上市 / Not Marketed). No licensed products are on record.
