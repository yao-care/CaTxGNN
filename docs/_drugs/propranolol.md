...
Propranolol has no active Health Canada drug licenses on file in this evidence pack (`total_licenses: 0`, market status: 未上市 / Not Marketed). No DIN-level product or indication data is available.
