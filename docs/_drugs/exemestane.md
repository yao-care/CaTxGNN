...
Exemestane (Aromasin) is a steroidal aromatase inhibitor originally approved for hormone receptor-positive breast cancer treatment in postmenopausal women.
The TxGNN model predicts it may be effective for **Antithrombin Deficiency Type 2**,
with **0 clinical trials** and **0 publications** currently supporting this direction — making this a model-only hypothesis at Evidence Level L5.
