...
Rocuronium currently holds **no Health Canada drug identification numbers (DINs)** in this evidence pack (`total_licenses = 0`, `market_status = 未上市 / Not Marketed`). No authorized indication text is available for review.
