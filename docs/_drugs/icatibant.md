...
No Health Canada Drug Identification Numbers (DIN) are on file for icatibant in this evidence pack (`total_licenses: 0`, `market_status: Not marketed`). The product is not currently marketed in Canada.
