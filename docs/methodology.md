...
description: "How CaTxGNN produces and validates predictions: TxGNN knowledge graph prediction, evidence collection, L1-L5 grading, and decision recommendations."
---
...
<p class="key-answer" data-question="How does CaTxGNN produce its predictions?">
...
<li><strong>Evidence collection</strong>: for each predicted pair, evidence is gathered from ClinicalTrials.gov, PubMed, DrugBank and Health Canada.</li>
...
Drug approval data for Canada comes from Health Canada. Ingredient names are mapped to the
