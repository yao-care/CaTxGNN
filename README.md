# CaTxGNN - Canada: Drug Repurposing

> 本專案由 **藥提醒科技有限公司**（[yao.care](https://www.yao.care)）開發與維運。
> CaTxGNN 站台：<https://catxgnn.yao.care/>｜產品總覽：<https://www.yao.care/medical/txgnn/>

[![Website](https://img.shields.io/badge/Website-catxgnn.yao.care-blue)](https://catxgnn.yao.care)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

Drug repurposing predictions for Canada Health Canada-approved drugs using the TxGNN model.
...
| **DHI Data** | 35 |
| **DDSI Data** | 8,359 |
| **FHIR Resources** | 1,254 MK / 49,527 CUD |
...
| **L5** | 1254 | Computational prediction only |
...
| Metric | Value |
|------|------|
| Health Canada Total Drugs | 16,120 |
| Repurposing Candidates | 21,392,510 |

### Deep Learning Method

```bash
conda activate txgnn
PYTHONPATH=src python -m catxgnn.predict.txgnn_model
```

| Metric | Value |
|------|------|
| Total DL Predictions | 2,526,968 |
| Unique Drugs | 1,254 |
| Unique Indications | 17,081 |
...
flowchart TD
    ...
    subgraph B["Step 1: DrugBundle Collector"]
        B1["Drug-level: Health Canada, DDI, DrugBank"]
...
| File | Download |
|------|------|
| Health Canada Data | [Drug Product Database (DPD)](https://www.canada.ca/en/health-canada/services/drugs-health-products/drug-products/drug-product-database.html) |
...
|------|------|------|------|
| **Drug Data** | Health Canada | [Drug Product Database (DPD)](https://www.canada.ca/en/health-canada/services/drugs-health-products/drug-products/drug-product-database.html) | Canada |
...
```mermaid
flowchart TD
    FDA["Health Canada Data"] --> proc["process_fda_data.py"]
    TxGNN["TxGNN Data"] --> prep["prepare_external_data.py"]

    proc --> json["ca_fda_drugs.json"]
...
```bibtex
@software{catxgnn2026,
  author       = {Yao.Care},
  title        = {CaTxGNN: Drug Repurposing Validation Reports for Canada Health Canada Drugs},
  year         = 2026,
  publisher    = {GitHub},
  url          = {https://github.com/yao-care/CaTxGNN}
}
```
